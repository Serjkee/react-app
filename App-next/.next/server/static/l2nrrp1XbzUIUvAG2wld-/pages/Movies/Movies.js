...
module.exports = __webpack_require__("qwfp");
...
function (_Component) {
  ...
  function Cards(props) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(Cards).call(this, props));
  }
...
function Cards_hoc_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { Cards_hoc_typeof = function _typeof(obj) { return typeof obj; }; } else { Cards_hoc_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return Cards_hoc_typeof(obj); }

function Cards_hoc_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function Cards_hoc_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function Cards_hoc_createClass(Constructor, protoProps, staticProps) { if (protoProps) Cards_hoc_defineProperties(Constructor.prototype, protoProps); if (staticProps) Cards_hoc_defineProperties(Constructor, staticProps); return Constructor; }

function Cards_hoc_possibleConstructorReturn(self, call) { if (call && (Cards_hoc_typeof(call) === "object" || typeof call === "function")) { return call; } return Cards_hoc_assertThisInitialized(self); }

function Cards_hoc_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function Cards_hoc_getPrototypeOf(o) { Cards_hoc_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return Cards_hoc_getPrototypeOf(o); }

function Cards_hoc_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) Cards_hoc_setPrototypeOf(subClass, superClass); }

function Cards_hoc_setPrototypeOf(o, p) { Cards_hoc_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return Cards_hoc_setPrototypeOf(o, p); }
...
/*#__PURE__*/
function (_Component) {
  Cards_hoc_inherits(CardsHOC, _Component);

  function CardsHOC(props) {
    Cards_hoc_classCallCheck(this, CardsHOC);

    return Cards_hoc_possibleConstructorReturn(this, Cards_hoc_getPrototypeOf(CardsHOC).call(this, props));
  }

  Cards_hoc_createClass(CardsHOC, [{
...
function (_Component) {
  ...
  function Header(props) {
    ...
    return Header_possibleConstructorReturn(this, Header_getPrototypeOf(Header).call(this, props));
  }
...
/*#__PURE__*/
function (_Component) {
  _inherits(SortingSection, _Component);

  function SortingSection(props) {
    _classCallCheck(this, SortingSection);

    return _possibleConstructorReturn(this, _getPrototypeOf(SortingSection).call(this, props));
  }

  _createClass(SortingSection, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement("div", {
...
function SortingSection_hoc_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { SortingSection_hoc_typeof = function _typeof(obj) { return typeof obj; }; } else { SortingSection_hoc_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return SortingSection_hoc_typeof(obj); }

function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }

function SortingSection_hoc_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function SortingSection_hoc_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function SortingSection_hoc_createClass(Constructor, protoProps, staticProps) { if (protoProps) SortingSection_hoc_defineProperties(Constructor.prototype, protoProps); if (staticProps) SortingSection_hoc_defineProperties(Constructor, staticProps); return Constructor; }

function SortingSection_hoc_possibleConstructorReturn(self, call) { if (call && (SortingSection_hoc_typeof(call) === "object" || typeof call === "function")) { return call; } return SortingSection_hoc_assertThisInitialized(self); }

function SortingSection_hoc_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function SortingSection_hoc_getPrototypeOf(o) { SortingSection_hoc_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return SortingSection_hoc_getPrototypeOf(o); }

function SortingSection_hoc_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) SortingSection_hoc_setPrototypeOf(subClass, superClass); }

function SortingSection_hoc_setPrototypeOf(o, p) { SortingSection_hoc_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return SortingSection_hoc_setPrototypeOf(o, p); }
...
/*#__PURE__*/
function (_Component) {
  SortingSection_hoc_inherits(SortingSectionHOC, _Component);

  function SortingSectionHOC(props) {
    SortingSection_hoc_classCallCheck(this, SortingSectionHOC);

    return SortingSection_hoc_possibleConstructorReturn(this, SortingSection_hoc_getPrototypeOf(SortingSectionHOC).call(this, props));
  }

  SortingSection_hoc_createClass(SortingSectionHOC, [{
    key: "render",
    value: function render() {
