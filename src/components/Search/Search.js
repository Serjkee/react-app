    ...
    return (
      <form onSubmit={this.submitForm.bind(this)}>
        ...
        <div className='header-filters' >
          <SearchFilters />
          <SearchButton buttonClass='filter' onCustomSubmit={() => this.props.onSubmitForm(this.props.searchValue, this.props.searchBy, this.props.sortBy)} ><Link to='/movies' >Search</Link></SearchButton>
        </div>
      </form>
    )
  }
